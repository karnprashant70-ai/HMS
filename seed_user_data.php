...
if ($checkDoc->num_rows === 0) {
    ...
    $conn->query("INSERT INTO tbl_doctor (first_name, last_name, gender, phone_number, email, password, temporary_address, permanent_address, marital_status, department, specialization, qualification, licence_number, years_experience, consultation_fee, available_time, status, OTP) VALUES ('Jane', 'Smith', 'Female', '9847654321', '$doctorEmail', '$hashedPwd', 'Lalitpur', 'Lalitpur', 'Married', 'Cardiology', 'Cardiologist', 'MD Cardiology', 'LIC-12345', 10, 500.00, 'Mon-Fri 10:00 AM - 4:00 PM', 'Available', '000000')");
